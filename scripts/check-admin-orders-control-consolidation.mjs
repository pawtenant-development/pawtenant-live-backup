...
function runSelfTest() {
  // NORMALISE LINE ENDINGS BEFORE PLANTING. core.autocrlf=true checks this repo
  // out with CRLF while the multi-line anchors above are written with \n, so
  // without this the plant matches nothing and the control silently no-ops.
