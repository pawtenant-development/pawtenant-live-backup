...
async function runChecks() {
  ...
  const allowedAfterClosure = new Set([
    ...
    // PARTNER-PRODUCTION-RATE-CORRECTION-001 — owner-approved correction of
    // My Pet ESA's uninvoiced $55 acceptance snapshots to $60, plus production
    // activation and complete $60 rate-card coverage for My Pet ESA/SignMyESA.
