...
function runSelfTest() {
  ...
  let pageSrc = "";
  // NORMALISE LINE ENDINGS BEFORE PLANTING. core.autocrlf=true checks this
  // repo out with CRLF, while the multi-line anchors below are written with
  // \n. Without this, String.replace silently matches nothing and the control
  // degrades into a no-op that reports success forever.
  try { pageSrc = readFileSync(PAGE, "utf8").replace(/\r\n/g, "\n"); } catch { pageSrc = ""; }
