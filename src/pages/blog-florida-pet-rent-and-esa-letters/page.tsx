// Blog article — /blog/florida-pet-rent-and-esa-letters
...
export default function BlogFloridaPetRentEsaLettersPage() {
  return <StatePetRentBlog cfg={statePetRentBlogs["florida-pet-rent-and-esa-letters"]} />;
}
