...
const faqs = [
  ...
  { q: "What does an ESA letter enable me to do?", a: "A valid ESA letter may support a reasonable-accommodation request under the Fair Housing Act — which can include asking to live with your emotional support animal in no-pet housing and asking a housing provider to waive pet deposits or fees that apply to assistance animals. Each request is reviewed individually and approval is not automatic; state law and housing type may still matter." },
