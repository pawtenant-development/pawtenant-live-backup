// Blog article — /blog/washington-pet-rent-and-esa-letters
...
export default function BlogWashingtonPetRentEsaLettersPage() {
  return <StatePetRentBlog cfg={statePetRentBlogs["washington-pet-rent-and-esa-letters"]} />;
}
