...
// ESA letter $99/year or $110 one-time.
//
...
const faqs = [
  ...
  },
  {
    ...
    a: "Across the industry, a one-year ESA letter from a licensed provider typically runs from about $99 to $199. At PawTenant the ESA letter is $99 per year (annual subscription) or $110 one-time. Letters priced below $50 almost always skip a real evaluation — a red flag. Higher price alone does not mean stronger protection; what matters is that a licensed clinician conducted a genuine assessment.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-6">
          ...
          <div className="rounded-2xl bg-white border border-orange-200 shadow-[0_18px_45px_-25px_rgba(122,78,45,0.35)] p-5 sm:p-6">
            ...
            <ul className="space-y-2 text-sm text-gray-700 leading-relaxed">
              ...
              <li><strong className="text-gray-900">Cost:</strong> $99/year or $110 one-time at PawTenant ($99&ndash;$199 is the typical industry range)</li>
      ...
      <article className="bg-white pb-4">
        <div className="max-w-3xl mx-auto px-5 sm:px-6">
          ...
          <Para>
            ...
            letter is $99 per year or $110 one-time — see{" "}
