// Blog article — /blog/new-york-pet-rent-and-esa-letters
...
export default function BlogNewYorkPetRentEsaLettersPage() {
  return <StatePetRentBlog cfg={statePetRentBlogs["new-york-pet-rent-and-esa-letters"]} />;
}
