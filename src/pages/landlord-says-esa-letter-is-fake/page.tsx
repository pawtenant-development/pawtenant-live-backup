...
const proveSteps = [
  ...
  },
  {
    ...
    desc: "Share the provider's license number or the verification ID from the customer portal so they can enter it at pawtenant.com/verify and confirm it's authentic — without seeing your medical records.",
  },
  {
  ...
  return (
    <main>
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-6">
          <AIAnswerBox question="My landlord says my ESA letter is fake — what should I do?">
            <p>
              ...
              <strong>license number</strong> or the <strong>verification ID</strong> from your customer portal,
      ...
      <LifestyleImageSection
        ...
        body="The reason a genuine PawTenant letter holds up is simple: it names a provider licensed in your state, it's dated, and its order has a portal verification ID a landlord can enter. That turns a vague accusation into a quick, factual check — with your private details kept private."
        bullets={[
          "Provider license number a landlord can confirm publicly.",
          "A portal verification ID that proves authenticity, not your diagnosis.",
      ...
      <section className="py-14 sm:py-16 bg-white border-t border-gray-100">
        <div className="max-w-2xl mx-auto px-5 sm:px-6 text-center">
          ...
          <p className="text-gray-500 text-sm sm:text-base mb-7">
            ...
            ESA letter with a portal verification ID a landlord can enter — with a refund if you don't
            qualify.
          </p>
          <Link
            to={withAttribution("/assessment")}
        ...
        <div className="px-5 sm:px-6">
          <RelatedResources
            links={[
              ...
              { to: "/esa-letter-verification-id", title: "How ESA letter verification works", desc: "How a landlord confirms a letter by entering its portal verification ID." },
