  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <p className="text-orange-400 text-sm font-semibold tracking-widest uppercase mb-3">Still Have Questions?</p>
        <h2 className="text-4xl font-extrabold text-white mb-5">
          Get Your <span className="text-orange-400">ESA Letter</span> Today &amp; Keep Your Pet by Your Side
        </h2>
        <p className="text-gray-300 text-base max-w-xl mx-auto mb-10">
          Our team of licensed professionals is ready to help you secure your emotional support animal letter quickly and affordably.
        </p>
