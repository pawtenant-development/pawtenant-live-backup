...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: "PawTenant's PSD letter is $129 for 1 dog, or a fixed $149 total covering 2 or 3 dogs — with letters typically delivered within 24 hours after provider review, plus an annual plan. Every plan includes a licensed provider review, and you're refunded if you don't qualify.",
  },
  {
