...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: "PawTenant's PSD letter is $129 and covers up to 2 dogs, or a fixed $149 total for exactly 3 dogs — with letters typically delivered within 24 hours after provider review, plus an annual plan. Every plan includes a licensed provider review, and you're refunded if you don't qualify.",
  },
  {
