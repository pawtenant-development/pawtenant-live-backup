...
const pawtenantPoints = [
  ...
  },
  {
    ...
    title: "Clear pricing",
    desc: "$115/year subscription or $129 one-time, shown before you start. No hidden 'registration' fees.",
  },
  {
...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Prices vary, but a legitimate letter reflects real clinical work by a licensed provider. PawTenant's ESA letter is $115/year or $129 one-time. Be cautious of letters priced far below the norm — that can signal the evaluation is being skipped, which makes the letter invalid.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-6">
          <AIAnswerBox question="What is the best online ESA letter service?">
            ...
            <p>
              ...
              clear $115/year or $129 one-time pricing, verifiable letters, and a refund if you don't
