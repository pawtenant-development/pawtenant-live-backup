...
const trustBlocks = [
  ...
  },
  {
    ...
    desc: "ESA letters are $115/year or $129 one-time, shown before you start. If you don't qualify after the clinical review, you're refunded — no charge for a letter you can't use.",
  },
  {
...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: "A PawTenant ESA letter is $115/year (annual subscription) or $129 one-time. The price is shown up front, and if you don't qualify after the clinical review you're refunded.",
  },
  {
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-6">
          <AIAnswerBox question="Is PawTenant legit?">
            ...
            <p>
              ...
              certificates, and refunds you if you don't qualify. Pricing is transparent: $115/year or
              $129 one-time.
            </p>
          </AIAnswerBox>
        </div>
