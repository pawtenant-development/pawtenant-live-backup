...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How much does an ESA letter cost?", a: "PawTenant's ESA letter is $129 as a one-time purchase covering up to 2 pets (delivered within 24 hours) — or a fixed $149 total that covers 3 pets. You can also choose the Annual Subscription at $115/year for one pet, or a fixed $135/year covering 2 or 3 pets, which auto-renews so you never lose housing protection. All plans include a consultation with a licensed mental health professional and a fully compliant ESA letter, with a full refund if you don't qualify." },
      { q: "What if my landlord doesn't accept my ESA letter?", a: "If your ESA letter meets all legal requirements and your landlord still refuses, you may have options under fair-housing law. A landlord must consider a valid reasonable-accommodation request — that is not the same as being required to accept every request. You can file a complaint with HUD (Department of Housing and Urban Development) or your state or local fair-housing agency. Housing-denial refund requests are reviewed under PawTenant's Refund Policy." }
    ]
  },
  {
    id: "psd",
    ...
    faqs: [
      ...
      { q: "How much does a PSD letter cost at PawTenant?", a: "PawTenant's PSD letter is $129 and covers up to 2 dogs, or a fixed $149 total for exactly 3 dogs — and letters are typically delivered within 24 hours after provider review. The Annual Subscription is $115/year for 1 dog, or a fixed $135/year covering 2 or 3 dogs. All plans include a consultation with a licensed professional." },
      { q: "Can a landlord refuse a psychiatric service dog?", a: "Under the Fair Housing Act, a housing provider must consider a reasonable-accommodation request for a psychiatric service dog and generally cannot deny it based only on a no-pet policy, breed restriction, or weight limit. They may request reliable documentation of your disability-related need when it isn't obvious, and may deny a request for a lawful, individualized reason (such as a genuine direct threat or undue burden). Each request is decided case by case. Note: the ADA 'two questions' rule applies to public access, not to housing." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Does my university need to accept my ESA letter from PawTenant?", a: "If your letter meets federal requirements and is issued by a properly licensed professional with an established relationship with you, universities must engage in the accommodation process. PawTenant letters are written by licensed professionals, with a full refund if you don't qualify." },
  ...
  },
  {
    ...
    faqs: [
      { q: "What is PawTenant's Landlord Verification feature?", a: "Every eligible ESA and PSD order receives a verification ID in the customer portal. Landlords can enter it at pawtenant.com/verify, and instantly confirm that your letter is authentic and valid — without ever seeing your personal health information. This is PawTenant's exclusive feature that sets our letters apart from every other ESA provider." },
      { q: "How does a landlord verify my ESA letter?", a: "It's simple: your landlord enters the verification ID from the customer portal at pawtenant.com/verify. The system instantly confirms whether the letter is valid, who issued it, and when it was issued. The entire process takes under 30 seconds and requires no account or login from the landlord." },
      ...
      { q: "Does every PawTenant letter include a way to verify it?", a: "Yes. Every eligible ESA and PSD order automatically receives a verification ID in the customer portal; the ID is not printed on the letter. There is no extra charge for this feature — it is included with every eligible order as part of our commitment to providing the most credible, landlord-accepted documentation available." },
      { q: "Can a landlord reject my letter even after verifying it?", a: "If a landlord verifies your letter and it shows as valid, they have confirmed the letter is authentic and issued by a licensed professional. A landlord must still consider your reasonable-accommodation request, though considering a request is not the same as being required to accept it. Housing-denial refund requests are reviewed under PawTenant's Refund Policy." },
      { q: "What if my landlord doesn't know about the verification feature?", a: "You can direct them to pawtenant.com/esa-letter-verification and share the verification ID from your customer portal. Many landlords are unfamiliar with verification systems because most ESA providers don't offer them — this is a PawTenant-exclusive feature. The verification page is designed to be self-explanatory for landlords who have never used it before." },
      { q: "Is portal verification the same as an ESA registration?", a: "No — they are completely different. ESA registries and online databases have no legal standing under federal law. PawTenant's verification is not a registry — it is proof of authenticity tied to a specific letter issued by a specific licensed professional. It verifies the letter itself, not a database entry. This distinction matters: landlords who are familiar with fair housing law will recognize the difference." }
    ]
  },
  {
    id: "process",
    ...
    faqs: [
      ...
      { q: "What is PawTenant's refund guarantee?", a: "If a licensed provider determines you don't qualify after your consultation, you receive a full refund. Housing-denial refund requests are reviewed under our Refund Policy. Approval by any landlord or university is never guaranteed. See our Refund Policy for full terms." },
      ...
      <section className="py-14 bg-[#fdf8f3]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-500 text-sm mb-7 leading-relaxed">
            Join 12,000+ families who have protected their rights with a PawTenant letter. Fast, affordable, and backed by our refund-if-you-don't-qualify guarantee.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <i className="ri-heart-line"></i>Get My ESA Letter — from $115
            </Link>
            <Link
              to="/psd-assessment"
            ...
            >
              <i className="ri-mental-health-line"></i>Get My PSD Letter — from $129
            </Link>
          </div>
        </div>
      </section>
