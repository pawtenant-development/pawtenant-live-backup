...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How much does a PSD letter cost at PawTenant?", a: "PawTenant's PSD letter is $129 for 1 dog, or a fixed $149 total covering 2 or 3 dogs — with your choice of Standard (2-3 business days) or Priority (within 24 hours) delivery at the same price. The Annual Subscription is $115/year for 1 dog, or a fixed $135/year covering 2 or 3 dogs. All plans include a consultation with a licensed professional." },
  ...
  },
  {
    ...
    faqs: [
      { q: "What is PawTenant's Landlord Verification feature?", a: "Every ESA and PSD letter issued by PawTenant carries a discreet verification QR code. Landlords scan it, land on pawtenant.com/esa-letter-verification, and instantly confirm that your letter is authentic and valid — without ever seeing your personal health information. This is PawTenant's exclusive feature that sets our letters apart from every other ESA provider." },
      { q: "How does a landlord verify my ESA letter?", a: "It's simple: your landlord scans the discreet QR code on your letter, which opens pawtenant.com/esa-letter-verification. The system instantly confirms whether the letter is valid, who issued it, and when it was issued. The entire process takes under 30 seconds and requires no account or login from the landlord." },
      ...
      { q: "Does every PawTenant letter include a way to verify it?", a: "Yes. Every ESA and PSD letter issued through PawTenant automatically carries a discreet verification QR code on the document. There is no extra charge for this feature — it is included with every letter as part of our commitment to providing the most credible, landlord-accepted documentation available." },
