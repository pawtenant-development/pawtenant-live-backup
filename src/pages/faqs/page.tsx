...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How much does an ESA letter cost?", a: "PawTenant's ESA letter is $129 as a one-time purchase (one pet, delivered within 24 hours) — or a fixed $149 total that covers 2 or 3 pets. You can also choose the Annual Subscription at $109/year for one pet, or a fixed $129/year covering 2 or 3 pets, which auto-renews so you never lose housing protection. All plans include a consultation with a licensed mental health professional and a fully compliant ESA letter with a 100% money-back guarantee." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How much does a PSD letter cost at PawTenant?", a: "PawTenant's PSD letter is $129 for 1 dog, or a fixed $149 total covering 2 or 3 dogs — with your choice of Standard (2-3 business days) or Priority (within 24 hours) delivery at the same price. The Annual Subscription is $109/year for 1 dog, or a fixed $129/year covering 2 or 3 dogs. All plans include a consultation with a licensed professional. Not sure yet? A quick 15-minute consultation with a licensed provider — covering ESA or PSD requirements, eligibility, and next steps — is $79." },
      ...
      <section className="py-14 bg-[#fdf8f3]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            >
              <i className="ri-heart-line"></i>Get My ESA Letter — from $109
            </Link>
            <Link
              to="/psd-assessment"
