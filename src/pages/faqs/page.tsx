...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "How much does an ESA letter cost?", a: "PawTenant's ESA letter is $129 as a one-time purchase (one pet, delivered within 24 hours) — or a fixed $149 total that covers 2 or 3 pets. You can also choose the Annual Subscription at $115/year for one pet, or a fixed $135/year covering 2 or 3 pets, which auto-renews so you never lose housing protection. All plans include a consultation with a licensed mental health professional and a fully compliant ESA letter with a 100% money-back guarantee." },
