    ...
    <div className="relative" ref={wrapRef}>
      ...
      >
        <span className="relative">
          <span className="w-8 h-8 flex items-center justify-center rounded-full bg-[#3b6ea5] text-white text-xs font-extrabold">
            {initials(name)}
          </span>
        ...
        <div className="absolute right-0 mt-2 w-72 bg-white border border-gray-200 rounded-2xl shadow-xl z-[130] overflow-hidden">
          ...
          <div className="px-4 py-3 border-b border-gray-100 flex items-center gap-3">
            <span className="relative flex-shrink-0">
              <span className="w-10 h-10 flex items-center justify-center rounded-full bg-[#3b6ea5] text-white text-sm font-extrabold">
                {initials(name)}
              </span>
