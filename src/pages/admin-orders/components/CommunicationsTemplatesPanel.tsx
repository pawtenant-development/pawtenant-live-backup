...
const MERGE_TAGS: MergeTag[] = [
  ...
  { tag: "{resume_url}",        meaning: "Secure single-use resume link. Generated at SEND time and expires in 24h — never a confirmation ID.", sample: "https://pawtenant.com/assessment?rt=rt_… (generated on send)",      scope: "global" },
  ...
  { tag: "{resume_url_with_promo}", meaning: "Secure single-use resume link with the recovery discount pre-applied.",           sample: "https://pawtenant.com/assessment?rt=rt_…&promo=SAVE20 (on send)",   scope: "template-specific" },
