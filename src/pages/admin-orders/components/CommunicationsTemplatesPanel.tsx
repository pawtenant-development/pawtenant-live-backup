...
const DEFAULT_SMS_TEMPLATES: SmsTemplate[] = [
  ...
  { id: "sms_finish_esa",          label: "Finish Your ESA Letter", group: "Lead Recovery",  body: "Hi {name}, you're one step away from your ESA letter! Complete your order here: {resume_url}" },
  { id: "sms_still_thinking",      label: "Still Thinking?",        group: "Lead Recovery",  body: "Hi {name}, still thinking about your ESA letter? Get it today and avoid housing issues. Complete here: {resume_url}" },
  { id: "sms_consultation_booked", label: "Consultation Booked",    group: "Lead Recovery",  body: "Hi {name}, your provider consultation with PawTenant is confirmed! Complete your payment to lock in your spot: {resume_url}" },
...
const MERGE_TAGS: MergeTag[] = [
  ...
  { tag: "{resume_url}",        meaning: "Stable checkout link. Reusable, never expires while the order is unpaid, and dies automatically once it is paid/completed/cancelled/refunded. Never a confirmation ID.", sample: "https://pawtenant.com/checkout/AB7K92QD",      scope: "global" },
  ...
  { tag: "{resume_url_with_promo}", meaning: "DEPRECATED — now renders the SAME bare stable link as {resume_url}. Discounts are never embedded in a customer URL; show the code in the message body instead.", sample: "https://pawtenant.com/checkout/AB7K92QD",   scope: "template-specific" },
