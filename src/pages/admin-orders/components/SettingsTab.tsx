...
// section of SettingsTab). SettingsTab still mounts them at their
// existing AccordionSections, so re-importing them as named exports
// restores the prior behavior with zero changes to either component's
// logic.
