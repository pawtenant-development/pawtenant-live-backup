...
const points = [
  {
    ...
    title: "Portal verification ID code",
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm mt-3 max-w-xl mx-auto leading-relaxed">
              Every eligible order receives a verification ID in the customer portal. Landlords can enter it at pawtenant.com/verify to confirm authenticity online — no health information is ever shared.
            </p>
          </div>
