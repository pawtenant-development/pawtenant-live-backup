...
export const DOCTORS: Doctor[] = [
  {
    ...
    bio: "Stephanie White, PsyD, LCSW, DCSW, BCD, is a highly experienced clinical social worker and doctoral-level clinician specializing in psychotherapy across outpatient, inpatient, and telehealth settings. With advanced training in clinical psychology, she provides comprehensive mental health evaluations and personalized treatment for conditions such as anxiety, depression, and emotional distress. She is dedicated to helping individuals achieve improved well-being, greater self-sufficiency, and lasting positive change.",
    ...
    verificationUrl: "https://growtherapy.com/provider/6e9dqjnwtec0/dr-stephanie-white",
  ...
  {
    id: "michelle-lafferty",
    name: "Michelle Lafferty",
    title: "LCSW",
    role: "Licensed Clinical Social Worker",
    bio: "Michelle Lafferty is a licensed clinical social worker with extensive experience supporting individuals navigating anxiety, depression, life transitions, and emotional wellness. She takes a compassionate, client-centered approach to mental health evaluations and is committed to helping clients access the support they need — including ESA letters — through a thorough and respectful clinical process.",
    states: ["NC", "PA", "VA"],
    highlights: ["LCSW", "Telehealth Evaluations", "Anxiety & Depression", "ESA Letters"],
    verificationUrl: "https://pawtenant.com/join-our-network",
    image: "https://storage.readdy-site.link/project_files/dfb46e5c-44ab-4c6d-87e4-adaf8c9bc491/1e8d425e-d72b-4920-9a45-e6ad84703725_headshot-1.jpg?v=7fba1a32f12f6d9f26f621096ff4053d",
    email: "mjones2378@yahoo.com",
    npi_number: null,
  },
  {
    id: "lytara-garcia",
