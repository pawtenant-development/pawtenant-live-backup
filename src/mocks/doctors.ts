...
export const DOCTORS: Doctor[] = [
  {
    ...
    bio: "Stephanie White is a Licensed Clinical Social Worker with over 10 years of experience in mental health counseling and ESA evaluations. She provides compassionate, professional telehealth evaluations for eligible patients seeking Emotional Support Animal documentation, with a focus on clear communication, privacy, and a respectful clinical experience.",
  ...
  },
  {
    ...
    bio: "Robert Staaf is a board-certified clinical social worker specializing in anxiety, depression, and emotional support animal evaluations. He is known for his clear communication and supportive online consultations, helping eligible patients across numerous states access the ESA documentation they need.",
  ...
  },
  {
    ...
    bio: "Lytara Garcia is an experienced licensed clinical social worker focused on trauma-informed care and ESA mental health assessments. She provides warm, efficient virtual evaluations with a strong emphasis on privacy, patient comfort, and thorough documentation for housing and travel needs.",
