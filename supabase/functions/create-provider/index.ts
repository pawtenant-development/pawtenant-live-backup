        ...
        <tr>
          <td style="padding:32px;">
            ...
            <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.7;">
              You've been added to the <strong>${COMPANY_NAME} Provider Network</strong>. Click the button below to set your password and activate your provider portal account.
            </p>
