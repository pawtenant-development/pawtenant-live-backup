...
| SEO Page | `/are-esa-letters-still-valid-after-hud-change` | ESA Valid After 2026 HUD Change? | HUD 2026 enforcement pivot | LIVE complete | `fcca75a` | `8518894` | LIVE yes | LIVE no | LIVE yes | No | Discovered / not indexed | In sitemap; NOT in llms.txt; awaiting index. |
...
| SEO Page | `/esa-pet-rent-deposit` | ESA Pet Rent & Deposit Guide | Pet fees/deposits | LIVE complete | `a36492e` | `8bf41d2` | LIVE yes | LIVE no | LIVE yes | No | URL unknown to Google | In sitemap; NOT in llms.txt; not yet known to Google. |
| SEO Page | `/how-to-verify-esa-letter` | How to Verify an ESA Letter | Verification center | LIVE complete | `7c28290` | `f30f1e4` | LIVE yes | LIVE no | LIVE yes | No | **Indexed** | Live 200; NOT in llms.txt but indexed. |
...
| SEO Page (state) | `/california-esa-letter-for-apartments` | California ESA Letter for Apartments | CA apartment-renter ESA housing | TEST complete / LIVE pending | `3f6b419` | — | TEST yes / LIVE no | TEST yes / LIVE no | TEST yes / LIVE no | No | Not live on LIVE (TEST only) | Prod serves SPA-fallback home shell; not a real LIVE page. Awaiting LIVE mirror approval. |
| SEO Page (state) | `/texas-esa-letter-for-apartments` | Texas ESA Letter for Apartments | TX apartment-renter ESA housing | TEST complete / LIVE pending | `3f6b419` | — | TEST yes / LIVE no | TEST yes / LIVE no | TEST yes / LIVE no | No | Not live on LIVE (TEST only) | Prod serves SPA-fallback home shell; not a real LIVE page. Awaiting LIVE mirror approval. |
| SEO Page (state) | `/florida-esa-letter-for-apartments` | Florida ESA Letter for Apartments | FL apartment/condo ESA housing | TEST complete / LIVE pending | `3f6b419` | — | TEST yes / LIVE no | TEST yes / LIVE no | TEST yes / LIVE no | No | Not live on LIVE (TEST only) | Prod serves SPA-fallback home shell; not a real LIVE page. Awaiting LIVE mirror approval. |
| SEO Page (state) | `/new-york-esa-letter-for-apartments` | New York ESA Letter for Apartments | NY apartment/co-op ESA housing | TEST complete / LIVE pending | `3f6b419` | — | TEST yes / LIVE no | TEST yes / LIVE no | TEST yes / LIVE no | No | Not live on LIVE (TEST only) | Prod serves SPA-fallback home shell; not a real LIVE page. Awaiting LIVE mirror approval. |
...
- TEST-only (not on LIVE): 4 state apartment pages — pending LIVE mirror.
