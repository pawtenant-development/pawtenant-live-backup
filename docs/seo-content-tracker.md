...
| Blog | `/blog/how-to-get-an-esa-letter-online` | How to Get an ESA Letter Online in 2026 | Transactional "how to get ESA letter online" | LIVE complete | `a19f5c2` | `440ef47` | LIVE yes | LIVE yes | LIVE yes | No | Not yet requested (LIVE deployed 2026-06-18) | LIVE mirror of TEST cluster. Compliance: placeholder "[Jane Doe, LCSW]" byline → "PawTenant Editorial"; "FHA Approved?"→"Recognized under the FHA"; softened accommodation/fee absolutes; removed CMS/internal-linking notes; clinician quote → editorial callout. Pricing matches site ($99/yr or $110 one-time). |
| Blog | `/blog/what-is-an-esa-letter` | What Is an ESA Letter? 2026 Legal Requirements | Informational "what is an ESA letter" | LIVE complete | `a19f5c2` | `440ef47` | LIVE yes | LIVE yes | LIVE yes | No | Not yet requested (LIVE deployed 2026-06-18) | LIVE mirror. Legal claims VERIFIED (Sept 2025 FHEO withdrawal; May 22 2026 HUD memo; CA AB 468; FL 760.27). 4-layer + 8-element responsive tables. Placeholder byline + "Clinical Review Board" badge removed → "PawTenant Editorial". |
| Blog | `/blog/esa-letter-requirements` | ESA Letter Requirements (Valid in 2026) | Informational "ESA letter requirements" | LIVE complete | `a19f5c2` | `440ef47` | LIVE yes | LIVE yes | LIVE yes | No | Not yet requested (LIVE deployed 2026-06-18) | LIVE mirror. ACCURACY fixes: FL removed from "30-day relationship" group (760.27 = bona fide relationship + valid assessment, not 30-day — that's CA/MT/IA/AR/LA); Henderson v. Five Properties LLC framed as fee-waiver-necessity ruling. 10-element + "looks-real-but-invalid" responsive tables + sources box. |
